...
class MainApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        menu_items = [
            "🏠 Tổng quan hệ thống", "📥 Văn bản đến", "📤 Văn bản đi", "📄 Văn bản nội bộ",
            "👥 Danh sách cán bộ", "📂 Danh mục chức vụ", "⏳ Thời hạn bảo quản", "🏷️ Loại văn bản",
            "🏢 Đơn vị, bộ phận", "⚙️ Xử lý công văn", "🔐 Phân quyền sử dụng", "🗂️ Mục lục hồ sơ",
